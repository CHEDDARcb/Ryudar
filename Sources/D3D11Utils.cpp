                                   ...
                                   ComPtr<ID3D11DepthStencilView> &depthStencilView)
{
	...
	if (FAILED(
	        device->CreateTexture2D(&depthStencilBufferDesc, 0, depthStencilBuffer.GetAddressOf())))
	{
    ...
    ComPtr<ID3D11VertexShader> &m_vertexShader, ComPtr<ID3D11InputLayout> &m_inputLayout)
{
	...
	HRESULT hr = D3DCompileFromFile(shaderPath.c_str(), 0, D3D_COMPILE_STANDARD_FILE_INCLUDE,
