...
{
	// IBL용 diffuse/specular cubemap을 로드한다.
	...
	// 스카이박스 셰이더는 POSITION만 사용하지만, 공통 Vertex layout과 맞춘다.
...
{
	// 스카이박스는 위치 이동 없이 카메라 방향과 projection만 반영한다.
